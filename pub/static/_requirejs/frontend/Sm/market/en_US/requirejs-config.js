...
(function() {
/**
 * Created by Vu Van Phan on 02-01-2016.
 */

var config = {
	map: {
		'*': {
			jquery214: 'Sm_ImageSlider/js/jquery-2.1.4.min',
			jqueryNoConflict : 'Sm_ImageSlider/js/jquery-noconflict',
			jquerySmMegaMenu : 'Sm_ImageSlider/js/owl.carousel'
		}
	}
};
require.config(config);
...
(function() {
/**
 * Created by Vu Van Phan on 30-12-2015.
 */
var config = {
	map: {
		'*': {
			jquery214: 'Sm_MegaMenu/js/jquery-2.1.4.min',
			jqueryNoConflict : 'Sm_MegaMenu/js/jquery-noconflict',
			jqueryMigrate : 'Sm_MegaMenu/js/jquery-migrate-1.2.1.min',
			jquerySmMegaMenu : 'Sm_MegaMenu/js/sm-megamenu'
		}
	}
};
require.config(config);
