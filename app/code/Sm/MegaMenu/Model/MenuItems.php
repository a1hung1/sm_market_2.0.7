...
class MenuItems extends AbstractModel implements MenuItemsInterface
{
	...
	public function getChildsDirectlyByItem($parent, $mode = 1)
	{
		...
		$status_child = \Sm\MegaMenu\Model\Config\Source\Status::STATUS_ENABLED;
		...
		";
		try {
			// $childrenItems = $this->getCollection()->getChildrenItems($depth_child_directly, $parent_id, $groupId);
