...
class Deals extends AbstractProduct
{
	...
	public function _getCfg($attr = null , $data = null)
	{
		...
		$defaults = [];
		$collection = $this->_scopeConfigInterface->getValue('deals', \Magento\Store\Model\ScopeInterface::SCOPE_STORES,$this->_storeId);
		...
		$_configs = $this->_scopeConfigInterface->getValue('deals', \Magento\Store\Model\ScopeInterface::SCOPE_STORES,$this->_storeId);
		if (empty($_configs)) return;
		$cfgs = [];

		foreach ($groups as $group) {
			$_cfgs = $this->_scopeConfigInterface->getValue('deals/'.$group.'', \Magento\Store\Model\ScopeInterface::SCOPE_STORES,$this->_storeId);
